    ...
    <div className="flex items-center gap-4 relative" ref={dropdownRef}>
      ...
      {!isAuthenticated && (
        <>
          <Link
            to="/register"
            className="hidden md:block bg-[#6F8FAF] text-slate-50 shadow-sm rounded-full px-4 py-1 font-medium hover:bg-[#5d7e9b] transition"
          >
            Sign up
          </Link>
          <span
            ...
            {!isAuthenticated ? (
              <>
                ...
                <Link
                  ...
                  className="block w-full text-center bg-[#6F8FAF] text-slate-50 shadow-sm rounded-full py-2 mb-2 font-semibold hover:bg-[#5d7e9b] transition"
                >
                  Sign up
                </Link>
                <button
